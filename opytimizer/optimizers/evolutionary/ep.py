...
class EP(Optimizer):
    ...
    References:
     	L. J. Fogel. The Future of Evolutionary Programming.
        Proceedings of the Conference on Signals, Systems and Computers (1990).
    ...
    def _update_strategy(self, strategy, lower_bound, upper_bound):
        ...
        # Generates a uniform random number
        r1 = r.generate_gaussian_random_number(
            size=(strategy.shape[0], strategy.shape[1]))
