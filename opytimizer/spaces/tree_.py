...
class TreeSpace(Space):
    ...
    def prefix(self, tree, position, left_son, type, c):
        """
        """
        ...
        if tree:
            ...
            if c == position:
                ...
                node = self.prefix(tree.left, position, left_son, type, c)
                if node:
                    return node
                else:
                    node = self.prefix(tree.right, position, left_son, type, c)
                    if node:
                        return node
                    else:
                        return None
