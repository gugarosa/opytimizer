...
c.plot(agent_pos[0], agent_pos[1], labels=['agent[0]',
                                           'agent[1]'], title="Convergence plot of agent's positions")

# Plotting the convergence of best agent's positions
c.plot(best_agent_pos[0], best_agent_pos[1], labels=[
       'best_agent[0]', 'best_agent[1]'], title="Convergence plot of best agent's positions")

# Plotting the convergence of agent's and best agent's fitness
c.plot(agent_fit, best_agent_fit, labels=[
       'agent', 'best_agent'], title="Convergence plot of agent's and best agent's fitness")
